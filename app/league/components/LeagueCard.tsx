...
export default function LeagueCard({ league }: Props) {
  ...
  return (
    <div
      onClick={handleClick}
      className="flex flex-col items-center bg-white dark:bg-gradient-to-b from-gray-200 to-gray-800 shadow-md rounded-xl p-6 hover:shadow-xl hover:scale-105 transition-all cursor-pointer"
    >
      {league.logo && (
        <Image
          src={league.logo}
